...
export const HTZ_BUSINESSES: HTZBusiness[] = [
  ...
  { id: 'h15', name: 'גאנט', tagline: 'GANT - אופנה פרפי בינלאומית', category: 'fashion', areas: ['תל אביב והמרכז'], online: true, imageUrl: U('1507003211169-0a1dd7228f2d'), logoText: 'GANT' },
  { id: 'h16', name: 'גולף אנד קו', tagline: 'GOLF&CO - אופנה יוקרתית', category: 'fashion', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1515886657613-9f3515b0c78f'), logoText: 'G&CO' },
  { id: 'h17', name: 'LAAVIN', tagline: 'אופנה עכשווית אונליין', category: 'fashion', areas: ['אונליין'], online: true, imageUrl: U('1576566588080-c81bb1cff597'), logoText: 'LAV' },
  ...
  { id: 'h24', name: 'פמינה', tagline: 'Femina - הלבשה תחתונה לכלה', category: 'fashion', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1523381210434-271e8be8a52e'), logoText: 'fem' },
  { id: 'h25', name: 'יולו', tagline: 'YOLO - אופנה צעירה ועכשווית', category: 'fashion', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1617096200347-cb04ae810b1d'), logoText: 'YOLO' },
  ...
  { id: 'h27', name: 'סולוג', tagline: 'Solog - אופנה נשית', category: 'fashion', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1551537396-5a15af0ac74e'), logoText: 'SOL' },
  { id: 'h28', name: 'פולגת', tagline: 'Polgat - לבוש יומיומי', category: 'fashion', areas: ['תל אביב והמרכז','חיפה והצפון'], online: false, imageUrl: U('1434389773234-6c9fc0116e9f'), logoText: 'PLG' },
  { id: 'h29', name: 'אמפוריום', tagline: 'Emporium - אופנה מובחרת', category: 'fashion', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1577450035-75f44f2d1da2'), logoText: 'EMP' },
  { id: 'h30', name: "ג'ק קובה", tagline: 'Jack Kuba - לינגרי יוקרתי', category: 'fashion', areas: ['אונליין'], online: true, imageUrl: U('1583847268964-b28dc8f51f92'), logoText: 'JK' },
  ...
  { id: 'h31', name: 'טאיזו', tagline: 'מסעדת שף מזרח אסיה', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1580822184713-fc5400e7fe10'), logoText: 'TAI' },
  ...
  { id: 'h33', name: 'קפה פלורה במשתלה', tagline: 'קפה בוטיק במשתלה', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1565299624946-b28f40a0ae38'), logoText: 'FL' },
  ...
  { id: 'h38', name: 'אגוסטין', tagline: 'Augustine Brasserie - מבית נואר', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1572441710183-7e6fad1dace0'), logoText: 'AUG' },
  { id: 'h39', name: 'מסעדת לונל', tagline: 'Lunel - מסעדה יוקרתית', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1414235077428-338989a2e8c0').replace('338989a2e8c0', '3f9ceeea85b2'), logoText: 'LUN' },
  ...
  { id: 'h44', name: "טולמן'ס דוט", tagline: 'TOLLMANS DOT - מסעדה', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1567620905732-2d1ec7ab7445'), logoText: 'TOL' },
  ...
  { id: 'h47', name: 'קפה פופולר', tagline: 'Cafe Popular - קפה ומזון', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1519984388953-d2406bc725e1'), logoText: 'POP' },
  { id: 'h48', name: "ג'ורג' וג'ון", tagline: "George & John - ברסרי", category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1544025162-d76538147789'), logoText: 'G&J' },
  ...
  { id: 'h51', name: 'פורטונה - כולא פיצה', tagline: 'פיצריה ומסעדה', category: 'food', areas: ['חיפה והצפון'], online: false, imageUrl: U('1571781926291-c477ebfd024b').replace('c477ebfd024b','8126bbd31fec'), logoText: 'FOR' },
  ...
  { id: 'h56', name: 'רשת אצה סושי בר', tagline: 'סושי טרי ואיכותי', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1553361371-9b09c68b0a4c'), logoText: 'אצה' },
  ...
  { id: 'h59', name: 'פוד אפיל', tagline: 'food appeal - מסעדה', category: 'food', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1567361640-8ab3a3bfaabb').replace('8ab3a3bfaabb','3a07b8a2c9a6'), logoText: 'FA' },
  ...
  { id: 'h62', name: 'קלרינס', tagline: 'Clarins - קוסמטיקה צרפתית', category: 'beauty', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1541643600914-78b084683702'), logoText: 'CLA' },
  ...
  { id: 'h64', name: 'קליניק', tagline: 'Clinique - קוסמטיקה רפואית', category: 'beauty', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1596462502278-27bfdc798ce3'), logoText: 'CLQ' },
  ...
  { id: 'h66', name: 'ספא מלכת שבא', tagline: 'Sheba Spa - ספא מפנק', category: 'beauty', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1487412947147-5cebf100d293'), logoText: 'SHB' },
  ...
  { id: 'h69', name: 'אופטיקנה', tagline: 'opticana - רשת אופטיקה', category: 'beauty', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1484349971757-4d0de0c07f98'), logoText: 'OPT' },
  { id: 'h70', name: 'הספר הכחול', tagline: 'Blue Book - אופטיקה', category: 'beauty', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1577401132921-cb47b1e97522').replace('cb47b1e97522','5e26e10b4aa1'), logoText: 'BLU' },
  { id: 'h71', name: 'ספא מלון קאמי', tagline: 'ספא יוקרתי במלון קאמי', category: 'beauty', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1519823985500-8bef3d5aec02').replace('8bef3d5aec02','cba84d413f09'), logoText: 'SPA' },
  { id: 'h120', name: 'סלון יווני - זיכרון יעקב', tagline: 'טיפולי שיער יווניים', category: 'beauty', areas: ['חיפה והצפון'], online: false, imageUrl: U('1522337360788-8b13dee7a37e').replace('8b13dee7a37e','c8b79ef8f62e'), logoText: 'SLN' },
  ...
  { id: 'h78', name: 'LINENZ', tagline: 'מצעים וטקסטיל אונליין', category: 'home', areas: ['אונליין'], online: true, imageUrl: U('1583847268964-b28dc8f51f92').replace('b28dc8f51f92','6b90a9f9d6eb'), logoText: 'LIN' },
  ...
  { id: 'h80', name: 'ארונות הזה Redwood', tagline: 'ארונות ורהיטים מובחרים', category: 'home', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1555041469-a586c61ea9bc').replace('a586c61ea9bc','7d5e3e882090'), logoText: 'RW' },
  { id: 'h81', name: 'שטיחי כרמל', tagline: 'שטיחים לבית', category: 'home', areas: ['אונליין'], online: true, imageUrl: U('1586023492125-27264fee4c4b'), logoText: 'כרמל' },
  { id: 'h82', name: 'next heat', tagline: 'מוצרי חימום לבית', category: 'home', areas: ['אונליין'], online: true, imageUrl: U('1564078516393-cf04bd966897'), logoText: 'NEXT' },
  ...
  { id: 'h84', name: 'דארלן', tagline: 'Darlain - רהיטי בית ועיצוב', category: 'home', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1538688273852-e29d044ef8cd'), logoText: 'DAR' },
  { id: 'h85', name: 'כיתן', tagline: 'Kitan - מצעים ומגבות', category: 'home', areas: ['תל אביב והמרכז','חיפה והצפון'], online: false, imageUrl: U('1578683760848-d7c8b5aafc29'), logoText: 'כיתן' },
  { id: 'h86', name: 'רהיטי קיסר', tagline: 'Kaisar - רהיטים לבית', category: 'home', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1555041469-a586c61ea9bc').replace('a586c61ea9bc','6b21d19b4bde'), logoText: 'KAI' },
  { id: 'h87', name: 'טרקלין חשמל', tagline: 'מוצרי חשמל לבית', category: 'home', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1491558103990-f3df2a98f3b4'), logoText: 'TRK' },
  ...
  { id: 'h96', name: 'Napo מבית ד"ר גב', tagline: 'נעלי בריאות ונוחות', category: 'shoes', areas: ['אונליין'], online: true, imageUrl: U('1560769629-9af6c57aef93').replace('9af6c57aef93','3d8e3571e8cf'), logoText: 'NAP' },
  ...
  { id: 'h100', name: 'The North Face', tagline: 'ציוד הרים ושכבות', category: 'sports', areas: ['אונליין'], online: true, imageUrl: U('1580058369020-c7499d2e3bfd'), logoText: 'TNF' },
  { id: 'h101', name: 'למטייל', tagline: 'ציוד טיולים ואאוטדור', category: 'sports', areas: ['תל אביב והמרכז','חיפה והצפון'], online: false, imageUrl: U('1472791201761-8f64c90d70bf').replace('8f64c90d70bf','7f88cdc4f4fe'), logoText: 'LMT' },
  ...
  { id: 'h103', name: 'ZMRM - משוברים לחופשה', tagline: 'חבילות נופש וטיולים', category: 'sports', areas: ['אונליין'], online: true, imageUrl: U('1488646953279-86b9cc8cbfa8').replace('86b9cc8cbfa8','2374a4eedf7b'), logoText: 'ZMR' },
  ...
  { id: 'h108', name: 'תנדלה', tagline: 'Tendelle - אופנה לילדים', category: 'kids', areas: ['תל אביב והמרכז'], online: false, imageUrl: U('1518831959646-742c3a14ebf5'), logoText: 'TND' },
  ...
  { id: 'h117', name: 'Vintage Original', tagline: 'משקפיים ואקססוריז', category: 'jewelry', areas: ['אונליין'], online: true, imageUrl: U('1574781814966-c3dce3b4e4df').replace('c3dce3b4e4df','e5d0b98c5e3e'), logoText: 'VO' },
